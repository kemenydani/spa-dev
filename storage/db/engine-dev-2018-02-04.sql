...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2018. Feb 04. 17:16
...
(7, '', '', '', 16),
(8, '', '', '', 16),
(9, 'xdfvxyvxcv', 'vxcvxcvxc', 'xcvxcvxcvx', 16),
(10, 'test33', 'test33', 'test33', 16),
(11, 'test33', 'test33', 'test33', 16);

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `_xyz_article_categories`
--
...
--
-- A tábla adatainak kiíratása `_xyz_article_categories`
--
...
--
-- Tábla szerkezet ehhez a táblához `_xyz_category`
--
...
--
-- A tábla adatainak kiíratása `_xyz_category`
--
...
--
-- A tábla indexei `_xyz_article_categories`
--
...
--
-- AUTO_INCREMENT a táblához `_xyz_category`
--
ALTER TABLE `_xyz_category`
...
--
-- Megkötések a táblához `_xyz_article_categories`
--
ALTER TABLE `_xyz_article_categories`
