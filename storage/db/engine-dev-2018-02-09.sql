...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2018 at 02:44 PM
...
--
-- Dumping data for table `_xyz_permission`
--

INSERT INTO `_xyz_permission` (`id`, `name`, `date_created`) VALUES
...
INSERT INTO `_xyz_squad` (`id`, `name`) VALUES
(1, 'squad1'),
(2, 'squad2'),
(3, 'team3'),
(4, 'team4');
...
INSERT INTO `_xyz_tournament` (`id`, `title`, `created_by`, `date_created`) VALUES
(1, 'tournament1', NULL, '2018-02-09 12:53:53'),
(2, 'tournament2', NULL, '2018-02-09 12:53:53');
...
--
-- Table structure for table `_xyz_user_permission`
--

CREATE TABLE `_xyz_user_permission` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Indexes for table `_xyz_user_permission`
--
ALTER TABLE `_xyz_user_permission`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
...
--
-- AUTO_INCREMENT for table `_xyz_user_permission`
--
ALTER TABLE `_xyz_user_permission`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `_xyz_user_permission`
--
ALTER TABLE `_xyz_user_permission`
  ADD CONSTRAINT `_xyz_user_permission_ibfk_1` FOREIGN KEY (`permisson_id`) REFERENCES `_xyz_permission` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `_xyz_user_permission_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `_xyz_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
